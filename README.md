...
The figure files are generated at runtime and are not committed to the repository.
Run the phase scripts above, then open the generated image files from the repository root:

- **Phase 1**: `phase1-class-balance.png`, `phase1-loop-scores.png`, `phase1-hidden-norms.png`
- **Phase 2**: `phase2-persistence-diagrams.png`, `phase2-barcodes.png`, `phase2-feature-distributions.png`, `phase2-correlations.png`
- **Phase 3**: `phase3-roc-curves.png`, `phase3-feature-importance.png`, `phase3-scatter.png`, `phase3-boxplots.png`, `phase3-confusion-matrix.png`, `phase3-calibration.png`
- **Phase 4**: `phase4-metric-comparison.png`, `phase4-per-prompt.png`, `phase4-intervention-timeline.png`, `phase4-suppressed-tokens.png`
